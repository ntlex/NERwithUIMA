...
import de.unihamburg.informatik.nlp4web.tutorial.tut5.feature.CityEntityExtractor;
import de.unihamburg.informatik.nlp4web.tutorial.tut5.feature.NameEntityExtractor;
import de.unihamburg.informatik.nlp4web.tutorial.tut5.feature.SurroundingCapFeature;
...
public class NERAnnotator extends CleartkSequenceAnnotator<String> {
    ...
    private FeatureExtractor1<Token> startsWithCaps;
    ...
    private CleartkExtractor<Token, Token> contextCapFeatureExtractor;
    ...
    public void initialize(UimaContext context) throws ResourceInitializationException {
        ...
        if (featureExtractionFile == null) {
            ...
            this.contextCapFeatureExtractor = new CleartkExtractor<Token, Token>(Token.class,
                    new FeatureFunctionExtractor<Token>(new CoveredTextExtractor<Token>(),
                            new SurroundingCapFeature()),
                    new Preceding(2), new Following(2));
          
            
            features.add(new FeatureFunctionExtractor<Token>(new NameEntityExtractor(new File("src/main/resources/ner/eng.list"))));
            features.add(new FeatureFunctionExtractor<Token>(new CityEntityExtractor(new File("src/main/resources/ner/worldcitiespop.txt"))));
            ...
            features.add(contextCapFeatureExtractor);
